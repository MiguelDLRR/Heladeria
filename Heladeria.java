...
import actividad05.ejercicio02.pideDatos.Pregunta;

public class Heladeria {
    public static void main(String[] args) {
        /*
         * 5• Inicialmente contenga un array de nombre “pedido” con los siguientes
         * valores: o El numero de loteria "119383939" de 3.5€ o Una horchata de 250ml, 20kcal,
         ...
         * 
         */
        Loteria numeroLoteria = new Loteria("119383939",3.5);
        ...
        Vendible[] pedido = { numeroLoteria, horchata, cucurucho1, cucurucho2 };
        ...
        do {
            operacion = Pregunta.pideEntero("Quieres hacer alguna otra operación?"
                    + "\n 1-Sustituye un pedido por una horchata" + "\n 2- Ver el pedido actual" + "\n 0- Salir");
    ...
    public static void mostrarPedido(Vendible[] pedido) {
        System.out.println("Información del pedido:");
        double totalPedido=0;
        for (int k = 0; k < pedido.length; k++) {
            totalPedido+=pedido[k].getPrecio();
            System.out.println(k + "-" + pedido[k]);
        }
        System.out.println("El coste total del pedido es de:"+totalPedido);

    }

    public static void addHorchata(Vendible[] pedido) {
