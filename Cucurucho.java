...
public class Cucurucho extends Comida {
    ...
    Debe llamar al superconstructor correspondiente para establecer que el tipo es "cucurucho"*/
    public Cucurucho(String nombre, double precio, double kcal, int numeroBolas) {
        super(nombre, precio, kcal, "cucurucho");
 ...
 */
    public double getPrecio(){
        double totalPrecio=super.getPrecio();
        for(int k=0;k<sabores_helado.length;k++){
